                  ...
                  <TableCell>
                    <div className="flex justify-end gap-1 sm:gap-2">
                      <Button 
                        ...
                        onClick={() => navigate(`/teacher/create-question?type=edit&course_id=${group.course_id}&category=${group.category}`)}
                      >
                      ...
                      <Button 
                        ...
                        size="icon"
                        className="h-8 w-8 sm:h-10 sm:w-10"
                        onClick={() => navigate(`/teacher/create-question?course_id=${group.course_id}&category=${group.category}`)}
                      >
